nested_test("concat") do
    ...
    nested_test("concatenate") do
        nested_test("empty") do
            concatenate(destination, "cell", sources)
            @test get_axis(destination, "cell") == ["A", "B", "C", "D", "E"]
            @test get_axis(destination, "dataset") == ["source.1!", "source.2!"]
    ...
    nested_test("prefix") do
        ...
        nested_test("true") do
            ...
            @test get_axis(destination, "cell") == ["A", "B", "C", "D", "E"]
            @test get_axis(destination, "metacell") == ["source.1!.M1", "source.2!.M1", "source.2!.M2"]
            @test get_axis(destination, "dataset") == ["source.1!", "source.2!"]
            @test get_vector(destination, "cell", "dataset") ==
                  ["source.1!", "source.1!", "source.2!", "source.2!", "source.2!"]
        ...
        nested_test("names") do
            ...
            @test get_axis(destination, "cell") == ["A", "B", "C", "D", "E"]
            @test get_axis(destination, "metacell") == ["D1.M1", "D2.M1", "D2.M2"]
            @test get_axis(destination, "dataset") == ["D1", "D2"]
