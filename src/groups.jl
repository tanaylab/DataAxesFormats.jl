...
"""
function compact_groups!(group_indices::AbstractVector{<:Integer})::Int
    n_groups = 0
...
"""
    function collect_group_members(
...
"""
function collect_group_members(group_indices::AbstractVector{T})::Vector{Vector{T}} where {T <: Integer}
